...
apt-get install -y git build-essential bison flex nsis texinfo gettext wget \
    python3 python3-pip \
    mingw64-i686-adwaita-themes mingw64-i686-adwaita-icon-theme mingw64-x86-64-adwaita-themes mingw64-x86-64-adwaita-icon-theme mingw64-i686-hicolor-icon-theme mingw64-x86-64-hicolor-icon-theme \
